...
all_data <- a_data %>%
  ...
  bind_rows(mutate(c_dyad, type = "dyad", condition = "child")) %>%
...
all_calculate_data <- a_calculate_data %>%
  ...
  bind_rows(mutate(c_dyad_calculate_data, type = "dyad", condition = "child")) %>%
...
all_spread_data <- a_spread_data %>%
  ...
  bind_rows(mutate(c_dyad_spread_data, type = "dyad", condition = "child"))%>%
...
all_bind_data <- a_bind_data %>%
  ...
  bind_rows(mutate(c_dyad_bind_data, type = "dyad", condition = "child")) %>%
